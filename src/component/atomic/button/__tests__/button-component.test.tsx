...
describe(`Testing Button Component With Tag Button`, () => {
  it(`Testing Button Normally`, () => {
    const onClickSpy = jest.fn();
    const { container } = render(
      <Button.Default onClick={onClickSpy}>Testing</Button.Default>
    );
  ...
  it(`Testing Button Rounded`, () => {
    const { container } = render(
      <Button.Default rounded size="big">
        Testing
      </Button.Default>
    );
  ...
  it(`Testing Button Dark`, () => {
    const { container } = render(
      <Button.Default theme="dark" size="small">
        Testing
      </Button.Default>
    );
  ...
  it(`Testing Button Outline`, () => {
    const { container } = render(
      <Button.Default outline>Testing</Button.Default>
    );
  ...
  it(`Testing Button With Icon & RTL`, () => {
    const { container } = render(
      <Button.Default rtl icon={<div style={{ height: 15, width: 15 }} />}>
        Testing
      </Button.Default>
    );

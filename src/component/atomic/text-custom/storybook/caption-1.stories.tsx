...
TextCustom.Caption1.displayName = `TextCustom.Caption1`;
...
const Template: Story<ICaptionProps> = (args) => (
  <TextCustom.Caption1 {...args} />
);

export default new Builder()
  .setModuleName(`Text Custom Component`)
  .setType(`atomic`)
  .setComponent(TextCustom.Caption1)
  .setMultipleArgs(
...
export const Caption1Styling = Template.bind({});

Caption1Styling.args = {
  children: `Sample Text Custom With Caption 1 Styling`,

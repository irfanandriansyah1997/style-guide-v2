...
TextCustom.Headline5.displayName = `TextCustom.Headline5`;
...
const Template: Story<ILabelProps> = (args) => (
  <TextCustom.Headline5 {...args} />
);

export default new Builder()
  .setModuleName(`Text Custom Component`)
  .setType(`atomic`)
  .setComponent(TextCustom.Headline5)
  .setMultipleArgs(
...
export const Headline5Styling = Template.bind({});

Headline5Styling.args = {
  children: `Sample Text Custom With Heading 5 Styling`,

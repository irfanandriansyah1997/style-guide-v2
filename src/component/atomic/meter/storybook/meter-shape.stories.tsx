...
import { CUSTOM_ARGS_METER_COMPONENT_ROUNDED } from './storybook-args';
...
export default new Builder()
  ...
  .setType(`atomic`)
  .setComponent(Meter)
  .setMultipleArgs(CUSTOM_ARGS_METER_COMPONENT_ROUNDED)
  .execute();
...
CustomHeight.args = {
  bgColor: STYLE_GUIDE_COLOR.light300,
  borderRadius: 10,
  color: STYLE_GUIDE_COLOR.warning500,
  height: 20,
  value: 10
};

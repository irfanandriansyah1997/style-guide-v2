...
describe(`Testing Pagination Component Component`, () => {
  ...
  it(`Testing With Custom Class Name`, () => {
    const onSpy = jest.fn((response) => response);
    const { container } = render(
      <Pagination
        disableInitialCallback
        ...
        className={{
          ...
          activeLink: `custom-activeLink`,
          break: `custom-break`,
          breakLink: `custom-breakLink`,
          container: `custom-container`,
          disabled: `custom-disabled`,
          next: `custom-next`,
          nextLink: `custom-nextLink`,
          page: `custom-page`,
          pageLink: `custom-pageLink`,
          previous: `custom-previous`,
          previousLink: `custom-previousLink`
        }}
        page={2}
        pageRange={2}
        totalPage={100}
